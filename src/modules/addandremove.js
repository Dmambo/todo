export default class TodoList {
    ...
    eventDelegation() {
        this.ulElement.addEventListener('click', (e) => {
            ...
            if (e.target.classList.contains('checkbox')) {
                this.checkedComplete(e.target.parentElement.parentElement.parentElement.id);
            }
        });
    }
    ...
    render() {
        ...
        this.todos.forEach((todo, index) => {
            ...
            <p class="list ${todo.completed ? 'completed' : ''}">${todo.description}</p>
    ...
    checkedComplete(target) {
        if (target.classList.contains('checkbox')) {
            target.parentElement.parentElement.parentElement.classList.toggle('completed');
        }
    }
}